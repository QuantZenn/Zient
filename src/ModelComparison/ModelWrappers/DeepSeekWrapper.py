...
class DeepSeekWrapper:
    def __init__(self, force_download: bool = False):
        self.model_name = "deepseek7b"
        self.model_id = "deepseek-ai/deepseek-llm-7b-base"
    ...
    def _predict_single(self, text: str) -> Union[dict, None]:
        ...
        conf_inputs = self.tokenizer(followup_prompt, return_tensors="pt").to(self.model.device)
        with torch.no_grad():
